...
int32_t tm_mqtt_init(int32_t (*recv_cb)(const int8_t * /** data_name*/, uint8_t * /** data*/,
                                        uint32_t /** data_len*/));
int32_t tm_mqtt_login(const int8_t *product_id, const int8_t *dev_name, const int8_t *dev_token,
                      uint32_t life_time, uint32_t timeout_ms);
int32_t tm_mqtt_logout(uint32_t timeout_ms);
int32_t tm_mqtt_step(uint32_t timeout_ms);
int32_t tm_mqtt_send_packet(const int8_t *topic, uint8_t *payload, uint32_t payload_len, uint32_t timeout_ms);
