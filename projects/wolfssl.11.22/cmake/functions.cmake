...
function(add_to_options_file DEFINITIONS OPTION_FILE)
    ...
    foreach(DEF IN LISTS DEFINITIONS)
        if(DEF MATCHES "^-D")
            ...
            #message("DEF_NO_EQUAL_NO_VAL=" DEF_NO_EQUAL_NO_VAL)
            #message("DEF_NO_PREFIX=" ${DEF_NO_PREFIX})

            if("${DEF_NO_PREFIX}" STREQUAL "")
                message("DEF_NO_PREFIX is empty-------------------------------------")
            else()
                message(REGEX REPLACE "=.*$" "" DEF_NO_EQUAL_NO_VAL ${DEF_NO_PREFIX})
                string(REGEX REPLACE "=.*$" "" DEF_NO_EQUAL_NO_VAL ${DEF_NO_PREFIX})
                message(REPLACE "=" " " DEF_NO_EQUAL ${DEF_NO_PREFIX})
