...
struct _ssl_context
{
     ...
     * PKI layer
     */
    rsa_context_EX *rsa_key;               /*!<  own RSA private key     */
    x509_cert_EX *own_cert;                /*!<  own X.509 certificate   */
    x509_cert_EX *ca_chain;                /*!<  own trusted CA chain    */
    x509_crl_EX *ca_crl;                   /*!<  trusted CA CRLs         */
    x509_cert_EX *peer_cert;               /*!<  peer X.509 cert chain   */
