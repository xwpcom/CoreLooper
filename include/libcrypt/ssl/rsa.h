...
typedef struct
{
    ...
    mpi_EX N;                      /*!<  public modulus    */
    mpi_EX E;                      /*!<  public exponent   */

    mpi_EX D;                      /*!<  private exponent  */
    mpi_EX P;                      /*!<  1st prime factor  */
    mpi_EX Q;                      /*!<  2nd prime factor  */
    mpi_EX DP;                     /*!<  D % (P - 1)       */
    mpi_EX DQ;                     /*!<  D % (Q - 1)       */
    mpi_EX QP;                     /*!<  1 / (Q % P)       */

    mpi_EX RN;                     /*!<  cached R^2 mod N  */
    mpi_EX RP;                     /*!<  cached R^2 mod P  */
    mpi_EX RQ;                     /*!<  cached R^2 mod Q  */
 ...
 *
 * \note           rsa_init_EX() must be called beforehand to setup
